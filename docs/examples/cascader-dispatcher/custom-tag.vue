<template>
  <div class="m-4">
    ...
    <el-cascader-dispatcher v-model="value1" :options="options" :props="props" clearable>
      <template #tag="{ data }">
        <el-tag
    ...
    <el-cascader-dispatcher v-model="value2" :options="options" :props="props" clearable>
      <template #tag="{ data }">
